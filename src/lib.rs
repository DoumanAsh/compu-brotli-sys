/* automatically generated by rust-bindgen 0.72.1 NOTE: bindgen can generate invalid enum repro, make sure to fix it to int */
...
pub const BrotliDecoderErrorCode_BROTLI_DECODER_ERROR_FORMAT_BLOCK_SWITCH: BrotliDecoderErrorCode =
    -17;
